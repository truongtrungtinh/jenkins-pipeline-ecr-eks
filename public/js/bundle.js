...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHJ1b25ndHJ1bmd0aW5oIiwiYSI6ImNrOWUzaXUwbzAzMXEzZW53ZTJpc2RmMHkifQ.ggl0RJmps8rze8TaU22A4g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/truongtrungtinh/ck9e490dd1gzn1ipjr5uln536',
    scrollZoom: false
  });
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Created account successfully');
...
var stripe = Stripe('pk_test_us78WX81n37EomR3kEeOlciB00u67msfcl');
...
} // - data-attribute and its corresponding DOM dataset.property
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.getElementById('btn-signup').textContent = 'Creating...';
            e.preventDefault();
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData(); // Can be used to submit forms and file uploads to other web applications.
